...
def main():
    ...
    adv_samples_fpath = pathlib.Path("target_model/mdeepcorr/Gbase/Gmdeepcorr_advsamples_time0.0000_size0.1481.p")
    ...
    output_filename = f"Gmdeepcorr_threshDC100_time0_{threshold_dc100:.4f}.p"
    result_fpath = pathlib.Path("target_model/mdeepcorr/Gbase") / output_filename
    results_to_save = {
