...
def main(mode: str,
    ...
    if mode == "train":
        ...
        for ep in range(max_ep):
            ...
            if np.mean(losses) < best_loss_mean and ep%5 == 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root",default = './datasets/CrawlE_Proc', type=str, help="Path to preprocessed .npz.")
    parser.add_argument("--ckpt", default='experiments/deepcoffea_deepcoffea_d3_ws5_nw11_thr20_tl500_el800_nt1000_ap1e-01_es64_lr1e-03_mep100000_bs256/best_loss.pth', type=str, help="Load path for the checkpoint model.")
