...
def calculate_efficiency_metrics(result_filename):
    ...
    print("--------------------------------------------------")
    print(f"总原始流量大小 (Sum of L1 norms): {total_original_size:,.2f} KB(scaled units)")
    print(f"总添加填充大小 (Sum of L1 norms): {total_padding_added:,.2f} KB(scaled units)")
...
if __name__ == '__main__':
    ...
    result_filename = 'target_model/mdeepcorr/Gbase/Gmdeepcorr_advsamples_time0.1463_size0.0367.p'
