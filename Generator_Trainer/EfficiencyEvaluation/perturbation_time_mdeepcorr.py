...
if __name__ == '__main__':
    ...
    # --- 检查点路径 (最重要的参数) ---
    # !!! 请确保这里的路径指向您希望测试的 m-deepcorr 生成器 .pth 文件 !!!
    args.checkpoints = 'checkpoints/deepcorr700/mdeepcorr_PatchTST_Deepcorr300_sl96_pl48_dm512_nh8/generator_checkpoint_3_acc_0.914_Gacc0.0433_advipd0.147_advsize0.037.pth' # <--- 修改这里
