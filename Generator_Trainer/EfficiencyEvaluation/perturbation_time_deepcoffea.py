...
from generator.generator import TSTGenerator # 现在可以正确导入了
...
def measure_cpu_overhead(args):
    ...
    print("--------------------------------------------------")
    print(f"平均CPU使用率 (Average CPU Usage): {avg_cpu_percent:.2f} % (on a single core)")
...
if __name__ == '__main__':
    ...
    args.seq_len = 150
    args.pred_len = 70
    args.patch_len = 10 # 示例值
    args.stride = 70 # 示例值
    args.enc_in = 2 # ipd, size
    args.d_model = 512
    args.n_heads = 8
    args.depth = 3
    args.scale_factor = 2
    ...
    args.checkpoints = 'checkpoints/deepcoffea/deepcoffea_d3_ws5_nw11_thr20_tl500_el800_nt1000_ap1e-01_es64_lr1e-03_mep100000_bs256/deepcoffea_PatchTST_Deepcoffea_sl150_pl70_dm512_nh8_pal10_s70/generator_checkpoint_16_cos0.163_advipd0.149_advsize0.005.pth'
