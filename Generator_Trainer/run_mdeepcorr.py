...
import os
import torch
from exp.exp_main_mdeepcorr import Exp_Main
import random
import numpy as np
import time

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='mdeepcorr')
    # random seed
    ...
    parser.add_argument('--target_model', type=str,  default='mDeepcorr',
                        help='model name, options: [mDeepcorr,Deepcorr300]')
    parser.add_argument('--adv_type', type=str,  default='time_and_size',
                    help='adv type, options: [time,size,time and size]')
    parser.add_argument('--target_model_path', type=str, default='./target_model/deepcorr/deepcorr700/', help='target model path')
    parser.add_argument('--flow_size', type=int, default=700, help='flow size')
    # data loader
    parser.add_argument('--data', type=str,  default='Deepcorr300', help='dataset name')
    parser.add_argument('--checkpoints', type=str, default='./checkpoints/deepcorr700/', help='location of model checkpoints')
