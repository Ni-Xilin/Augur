...
def calculate_metrics_at_fpr(all_labels, all_output, target_fpr=0.001):
    """
...
for result_fpath in [result_fpath1, result_fpath2, result_fpath3, result_fpath4,
    ...
    metrics = calculate_metrics_at_fpr(all_labels, all_outputs, target_fpr=0.001)
...
def deepcoffea_calculate_metrics_at_fpr(corr_matrix,threshhold_start,threshhold_end,n_wins=11, vote_thr=9,target_fpr=0.001):
...
if reuslt_metrics.exists():
    ...
    for result_fpath in [result_fpath1, result_fpath2,result_fpath3, result_fpath4,
        ...
        if(result_fpath.name == "corrmatrix_sim0.7404.npz"):
            metrics = deepcoffea_calculate_metrics_at_fpr(corr_matrix,threshhold_start=0.35,threshhold_end=0.325,n_wins=11, vote_thr=9,target_fpr=0.001)
