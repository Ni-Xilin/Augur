...
output_filename = "./plotwork/alone_roc1log.svg" # 修改输出文件名以区分
...
# --- 仅修改以下绘图的颜色部分 ---
# mDeepCorr
plt.plot(fpr_list_mdeepcorr[0], tpr_list_mdeepcorr[0], color='#1f77b4', lw=2.5, label=f'No-Perturbation with mDeepCorr', marker='o',markerfacecolor='white', linestyle='-', markersize=6) 
plt.plot(fpr_list_mdeepcorr[1], tpr_list_mdeepcorr[1], color='#8c564b', lw=2.5, label=f'Augur with mDeepCorr', marker='s',linestyle='-',markerfacecolor='white', markersize=6)
# DeepCorr
plt.plot(fpr_list_deepcorr[0], tpr_list_deepcorr[0], color='#2ca02c', lw=2.5, label=f'No-Perturbation with DeepCorr', marker='o',markerfacecolor='white', linestyle='-', markersize=6) 
plt.plot(fpr_list_deepcorr[1], tpr_list_deepcorr[1], color='#9467bd', lw=2.5, label=f'Augur with DeepCorr', marker='s', linestyle='-',markerfacecolor='white', markersize=6)
# DeepCoFFEA
plt.plot(fpr_list_deepcoffea[0], tpr_list_deepcoffea[0], color='#d62728', lw=2.5, label=f'No-Perturbation with DeepCoFFEA', marker='o',markerfacecolor='white', linestyle='-', markersize=6) 
plt.plot(fpr_list_deepcoffea[1], tpr_list_deepcoffea[1], color='#ff7f0e', lw=2.5, label=f'Augur with DeepCoFFEA', marker='s',markerfacecolor='white', linestyle='-', markersize=6)
# --- 颜色修改结束 ---
