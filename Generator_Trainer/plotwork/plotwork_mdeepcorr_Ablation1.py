...
result_fpath_time0 = pathlib.Path("target_model/mdeepcorr/Gbase/Gmdeepcorr_threshDC100_time0_0.0100.p")
result_fpath_size0 = pathlib.Path("target_model/mdeepcorr/Gbase/Gmdeepcorr_threshDC100_size0_0.0100.p")
Gresult_fpath = pathlib.Path("target_model/mdeepcorr/Gbase/Gmdeepcorr_threshDC100_0.0100.p")

output_filename = "./plotwork/mdeepcorr_ablation_roc1log.svg"
