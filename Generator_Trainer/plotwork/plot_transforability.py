...
result_fpath9 = pathlib.Path("target_model/deepcoffea/results/stats_deepcorr300/gthr.p")

output_filename = "./plotwork/transferablility_roc1log.svg"
...
# plt.plot(fpr_list[8], tpr_list[8], color='red', lw = 2, label=f'Augur Trained\non DeepCorr300', marker='o', linestyle='-', markersize=5)
# plt.plot(fpr_list[6], tpr_list[6], color='darkred', lw=1.5, label=f'Augur ', marker='.', linestyle='-', markersize=5)
...
plt.plot(fpr_list[8], tpr_list[8], color='red', lw = 2, label=f'Augur Trained\non DeepCorr300', marker='o',markerfacecolor='white', linestyle='-', markersize=6)
plt.plot(fpr_list[6], tpr_list[6], color='darkred', lw=1.5, label=f'Augur', marker='h',markerfacecolor='white', linestyle='-', markersize=6)
